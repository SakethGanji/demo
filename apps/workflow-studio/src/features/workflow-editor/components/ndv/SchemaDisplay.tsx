...
import type { NodeOutputSchema } from '@/shared/lib/api';

// The schema shape is declared once alongside NodeTypeInfo, which is where it
// comes from on the wire.
type SchemaProperty = NodeOutputSchema;
type OutputSchema = NodeOutputSchema;
